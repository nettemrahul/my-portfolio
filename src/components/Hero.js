...
const Hero = () => {
  return (
    <section id="about" className="py-5 text-center bg-white">
      <div className="container d-lg-flex align-items-center text-lg-start">
        <img
          src={`${process.env.PUBLIC_URL}/profile.jpg`}
          alt="Profile"
          className="rounded-circle shadow float-animation mx-auto mb-4"
          width="180"
          height="180"
        />
        <div className="ms-lg-5">
          ...
          <div className="d-flex gap-3 justify-content-center justify-content-lg-start mb-3">
